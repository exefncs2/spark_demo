...
let apiPoint = ''
let cssConfig = []
let sourcemap = process.env.CURRENT_ENT == 'production' ? '' : 'inline-source-map'
...
if(process.env.CURRENT_ENT == 'production'){
	cssConfig = [miniCssExtractPlugin.loader,'css-loader','sass-loader']
	htmlPoint.push(new uglifyjsPlugin())
	htmlPoint.push(new optimizeCssAssetsPlugin())
}else{
	cssConfig = ['style-loader',{loader:'css-loader'},'sass-loader']
}
